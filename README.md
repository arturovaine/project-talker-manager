...
- O endpoint retorna um array com todas as pessoas palestrantes cadastradas. Deve retornar o `status 200`, com o seguinte corpo:
...
- O endpoint retorna uma pessoa palestrante com base no id da rota. Deve retornar o `status 200` ao fazer uma requisição `/talker/1`, com o seguinte corpo:
...
- O endpoint deve retornar um token aleatório de 16 caracteres que deverá ser utilizado nas demais requisições.
...
- O endpoint deve adicionar uma nova pessoa palestrante ao seu arquivo;
...
- O endpoint deve editar uma pessoa palestrante com base no id da rota, sem alterar o id registrado.
